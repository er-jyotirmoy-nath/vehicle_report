...
if (isset($_POST ["veh_data_save"] [0]) && isset($_POST ["veh_data_save"] [1]) && isset($_POST ["veh_data_save"] [2]) && isset($_POST ["veh_data_save"] [3]) && isset($_POST ["veh_data_save"] [4]) && isset($_POST ["veh_data_save"] [5])) {
    try {
        ...
        $sql_cred = 'INSERT INTO `vehicle_master`'
                . '(`BA_no`, `veh_type`, `dt_mfr`, '
                . '`dt_induction`, `dt_takingover`, `class`, '
                . '`km_engine`, `km_chassis`, `engine_no`, '
                . '`chassis_no`) VALUES (' . ':BA_no,:veh_type,:dt_mfr,:dt_induction,'
                . ':dt_takingover,:class,:km_engine,:km_chassis,:engine_no,'
                . ':chassis_no)';
